...
#read data
load("C:/Users/wangl/Dropbox/projectLeftTruncation/realdata/finalDataInfection3LT.rdata")
...
result <- list(beta = bt,se = se_theta,CI = ci,time = fittime,gamma = gama)
...
plot(t,ff1/(1+yy1),type = "l",cex=0.5,col = 'red',ylab = "hazard",ylim = c(0,0.14))
points(t,ff/(1+yy),type = "l",cex=0.5,lty = 3,col = 'blue')
legend(10,0.14,legend = c('African American','Others'), col = c('red','blue'),lty = c(1,3))


plot(t,1/(1+yy1),type = "l", lty = 1,col = 'black',ylab = "Survival",ylim = c(0,1))
points(t,1/(1+yy),type = "l", lty = 3,col = 'blue')
legend(10,0.3,legend = c('African American','Others'), col = c('black','blue'),lty = c(1,3))
